        ...
        try:
            ...
            if hasattr(self.model, 'feature_name_'):
                ...
                self.features = [
                    ...
                    'AMT_REQ_CREDIT_BUREAU_YEAR', 'PREV_YEARS_LAST_DUE_MEAN', 'OCCUPATION_TYPE', 
                    'PREV_AMT_APPLICATION_MEDIAN', 'PREV_PRODUCT_COMBINATION_<LAMBDA>', 
                    'PREV_AMT_CREDIT_MEAN', 'CNT_FAM_MEMBERS', 'OBS_30_CNT_SOCIAL_CIRCLE', 
                    'OWN_CAR_AGE', 'PREV_AMT_APPLICATION_MEAN', 'PREV_AMT_GOODS_PRICE_MEDIAN', 
